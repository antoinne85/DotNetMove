...
namespace Microsoft.DotNet.Tools.Common
{
    ...
    {
        public static string GetRelativePathToFile(this SlnFile slnFile, string absolutePath)
        {
            return PathUtility.GetRelativePath(slnFile.FullPath, absolutePath);
        ...
        public static SlnSection GetSolutionFolderSection(this SlnFile slnFile)
        {
            return slnFile.Sections.GetOrCreateSection("NestedProjects", SlnSectionType.PreProcess);
        ...
        /// </summary>
        /// <param name="slnFile">The solution file to examine.</param>
        /// <param name="nestedProjects">The "NestedProjects" section of the solution file.</param>
        /// <returns>A dictionary of all of the solution folders present in the solution mapped to their IDs.</returns>
        /// <example>"SomeFolder\SomeSubFolder" => "{SOME-GUID}"</example>
        public static IDictionary<string, string> GetSolutionFolderPaths(
            this SlnFile slnFile,
